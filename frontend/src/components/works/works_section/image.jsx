...
function Image({ images }) {
    return (
        <div className="flex flex-row items-center justify-center h-full  space-x-3 md:space-x-4 lg:space-x-6 xl:space-x-8 px-4 py-2 sm:px-6 sm:py-2 lg:px-12 lg:py-3 xl:px-16 xl:py-4">
