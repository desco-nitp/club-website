...
const WorkHero = () => {
    return (
        <div className="flex flex-col">
            <div className="flex flex-row relative -top-[5rem] md:-top-[1.5rem] ">
                ...
                <div className=" w-1/2 md:w-1/3 flex flex-col items-center justify-center">   
                    <div className="absolute left-[55%] top-[7rem] hidden md:block sm:top-[9rem] lg:top-[10rem] xl:top-[14rem]">
                    ...
                    <div className="absolute left-[39%] top-[9.3rem] hidden md:block sm:top-[12.5rem] lg:top-[14.5rem] xl:top-[19.5rem] z-0">
                        <img src={V5} alt="Vector" className="h-[1.5rem] sm:h-[2rem] xl:h-[3rem]"/>
                    </div>
                </div>
                <div className="w-1/2 md:w-1/3 relative">
                    <div className="absolute z-10 -left-4 hidden md:block sm:-left-10 xl:-left-16 top-[7rem] sm:top-[9rem] xl:top-[12rem]">
                        <img src={V4} alt="Vector" className="h-[3rem] sm:h-[5rem] lg:h-[8rem] xl:h-[11rem]"/>
                    </div>
            ...
            <div className="relative px-[1rem] -top-28 sm:-top-20 xl:px-[3rem] xl:-top-28">
                <img
                src={GotImage}
                alt="" className=" h-24 sm:h-28 md:h-full">   
                </img>
            </div>
        </div>
    );
