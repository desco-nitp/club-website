...
const Footer = () => {
  return (
    <div className='footer h-20 flex bg-[#171717] text-white syne-fon justify-evenly items-center sm:pr-14 pr-3 '  >
        ...
        <div className=' flex  '>
            <div><img className=' sm:h-14 h-[2.3rem] p-1 sm:mx-3 mx-1' src={Facebook} alt="" /> </div>
            <div><img className=' sm:h-14 h-[2.3rem] p-1 sm:mx-3 mx-1' onClick={() => window.location.href = "https://www.linkedin.com/company/desco-nitp/mycompany/"} src={Linkedin} alt="" /></div>
            <div> <img className=' sm:h-14 h-[2.3rem] p-1 sm:mx-3 mx-1' onClick={()=>{window.location.href="https://www.instagram.com/desco.nitp/"}} src={Instagram} alt="" /> </div>
        </div>
    </div>
  )
}
